...
from .views import record_contribution, dashboard, manager_dashboard, view_contributions, extra_contributions_view, \
    send_reminder_message, export_contributions, confirm_send_messages, request_benefit, review_benefit_requests, process_benefit_request
...
urlpatterns = [
    ...
    # Staff Benefit Review
    path("admin/benefit-requests/", review_benefit_requests, name="review_benefit_requests"),
    path("admin/benefit-requests/<int:request_id>/<str:decision>/", process_benefit_request, name="process_benefit_request"),
]
